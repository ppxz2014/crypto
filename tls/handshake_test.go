...
func runMain(m *testing.M) int {
	...
	testConfig = &Config{
		...
		Rand:               zeroSource{},
		Certificates:       make([]Certificate, 3),
	...
	testConfig.Certificates[2].Certificate = [][]byte{[]byte(testSM2Cert)}
	testConfig.Certificates[2].PrivateKey = testSM2PrivateKey
...
var pemSM2Key = `
-----BEGIN PRIVATE KEY-----
MIGHAgEAMBMGByqGSM49AgEGCCqBHM9VAYItBG0wawIBAQQgxSRKo9PsJ+SzM7HG
Bg9R0OB36Ur3ZFCewoFbKfPI3uahRANCAAR5PZTEb5o/He73JkTp83TLFRY/gUEB
Z84vEG00DJpdRhBTxNhoPDlQfNoV+kkjanmrUeBcj0Cel6zVlSlG2nSK
-----END PRIVATE KEY-----
`

var certSM2 = `
-----BEGIN CERTIFICATE-----

...

h/OCouu/gr7SxfzsDJBVx/yavpm0IDr1DPkv
-----END CERTIFICATE-----
`

var block, _ = pem.Decode([]byte(pemSM2Key))

var testSM2PrivateKey, _ = x509.ParsePKCS8PrivateKey(block.Bytes)

var blockcert, _ = pem.Decode([]byte(certSM2))

var testSM2Cert = blockcert.Bytes
